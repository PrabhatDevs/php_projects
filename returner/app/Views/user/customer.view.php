    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('change_customer_status') ?>" method="post">
...
<script>
    function showEditModal(button, customerId, status) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        $(document).ready(function () {
            let table = $('#normal_table1').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: '<?= base_url('customers/fetch/customer_list') ?>',
                    type: 'POST',
                    data: function (d) {
                        d.name = $('#name').val();
                        d.email = $('#email').val();
                    ...
                    //     return json.data; // Ensure data is in correct format
                    // }
                },
                columns: [
                    {
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            return `<img src="https://alliedtechnologies.cloud/clients/pkg_return/api/v1/uploads/${data}" alt="">`;
                        }
                    },
                    { data: 'full_name' },
                    {
            ...
            <div class="d-flex gap-2">
                <a href="user/show?customer_id=${data}" class="border-0 bg-info text-white p-2 rounded-2">
                    <i class="fa fa-eye"></i>
                </a>
