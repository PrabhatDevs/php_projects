...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('platform/update') ?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="<?=base_url($platform['image'])??broken_img() ?>" alt="Platform Image" class="img-thumbnail mt-2" width="100">
                            </div>
                        </div>
                    </div>
